...
Node 24.18.0+ or 26+ and npm 11.19.1 required. PowerShell users — these all work as plain `npm` commands; no shell-specific syntax.
...
- `/run-mcp-content-evals` — source: `.agents/skills/run-mcp-content-evals/SKILL.md`
