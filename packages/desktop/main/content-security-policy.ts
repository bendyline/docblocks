 ...
 * policy makes every WebAssembly call throw a CompileError. The harper
 * proofing engine and the IronCalc formula engine are both WebAssembly, and
 * their workers inherit this same policy — omitting the token silently
 * disables them in packaged builds while leaving them working in development,
